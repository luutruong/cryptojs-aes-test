...
function encrypt(message, key) {
  ...
  // const keyMd5 = CryptoJS.SHA1(key).toString();

  const keyHash = CryptoJS.PBKDF2(key, salt, { hasher: CryptoJS.algo.SHA512, keySize: 64/8, iterations: 999 });
...
const encrypted = encrypter.encrypt('test-message', 'test-encrypt-key');
console.log(`Encrypted: ${encrypted}`);

const encrypted2 = encrypt('test-message', 'test-encrypt-key');
